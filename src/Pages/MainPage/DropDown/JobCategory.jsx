export const JobCategoryOptions = [
  { label: " فروش بازار یابی - سطوح کارشناسی", value: "1" },
  {
  ...
  { label: "دیجیتال مارکتینگ و سئو", value: "7" },
  ...
  { label: "عکاسی", value: "16" },
  { label: "مشاغل حوزه فیلم و سینما", value: "17" },
  { label: " طراحی موسیقی و صدا", value: "18" },
  { label: "(UI/UX) طراحی رابطه و تجربه کاربری ", value: "19" },
  { label: "مدیر محصول / مالک محصول", value: "20" },
  {
    label: "تحلیل و توسعه  کسب و کار / استراتژی  / برنامه ریزی ",
    value: "21",
  },
  { label: "خرید / تدارکات", value: "22" },
  {
    label: "مهندس صنایع / مدیریت تولید / مدیریت پروژه / مدیریت عملیات",
    value: "23",
  },
  { label: "خرید / تدارکات", value: "24" },
  { label: "بازگانی / تجارت", value: "25" },
  { label: "لجستیک / حمل و نقل / انبارداری", value: "26" },
  { label: "راننده / مسئول توزیع / پیک موتوری", value: "27" },
  { label: "مالی و حسابداری", value: "28" },
  { label: "معامله گر و تحلیل گر بازارهای مالی ", value: "29" },
  { label: "تحصیل دار / کارپرداز", value: "30" },
  { label: "مسئول دفتر / کارمند اداری ثبت اطلاعات / تایپیست", value: "31" },
  { label: "منابع انسانی", value: "32" },
  { label: "مدیر اجرایی", value: "33" },
  { label: "مدیر عامل / مدیر کارخانه", value: "34" },
  { label: "مهندسی برق", value: "35" },
  { label: "مهندسی پزشکی", value: "36" },
  { label: "مهندس مکانیگ / مهندس هوا فضا", value: "37" },
  ...
  { label: "مهندس کشاورزی / علوم دامی", value: "48" },
  { label: "زیست شناسی / علوم زیستی / علوم آزمایشگاهی", value: "49" },
  { label: "داروسازی/ بیوشیمی /شیمی", value: "50" },
  { label: "پزشک / دندان پزشک / دامپزشک ", value: "51" },
  {
    label: "پرستار بهیار / تکنسین حوزه سلامت و درمان /دستیاز پزشک",
    value: "52",
  },
  { label: "پرستار سالمند / پرستار کودک", value: "53" },
  ...
  { label: "کارگر ساده / نیروی خدماتی", value: "61" },
  { label: "تگنسین فنی / تعمیرکار / کارگر ماهر", value: "62" },
  { label: "... تخصص های ساختمانی /بنا / گچ کار /کاشی کار و ", value: "63" },
  { label: "مبل ساز/رنگ کار چوب/نجار / کابینت کار/MDF کار", value: "64" },
  { label: "آرایشگر", value: "65" },
  { label: "قناد و شیرنی پزی", value: "66" },
  { label: "بافنده فرش /قالی باف", value: "67" },
  { label: "نانوا", value: "68" },
  { label: "قفل و کلید ساز", value: "69" },
  { label: "قصاب", value: "70" },
  { label: "کفاش", value: "71" },
  { label: "خیاط", value: "72" },
  { label: "آشپز", value: "73" },
  { label: "کافی من /گارسون /باریستا", value: "74" },
  { label: "راهنمای تور /مهماندار", value: "75" },
  { label: "ورزش/ تربیت بدنی/تغذیه", value: "76" },
  { label: "تاریخ /جغرافیا / باستان شناسی", value: "77" },
  { label: "طراحی گرافیک / طراحی انیمیشن و موشن گرافیک", value: "78" },
];
